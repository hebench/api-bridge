...
3.  Confirm that all of the requirements have been satisfied for contributing (see below and the [HEBench PR Template](https://github.com/hebench/api-bridge/blob/main/.github/PULL_REQUEST_TEMPLATE.md)).
...
### Steps to Follow
Each repository in HEBench has build and run steps specific to the particular component. Please refer to [Building](https://github.com/hebench/api-bridge#building) and [Running the Benchmark](https://github.com/hebench/api-bridge#running-the-benchmark) for the steps specific to the HEBench API Bridge Reference Backend.
